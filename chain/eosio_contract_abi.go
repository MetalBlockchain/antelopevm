...
func EosioContractAbi() *abi.ContractAbi {
	eosAbi := abi.ContractAbi{}
	...
	eosAbi.Actions = append(eosAbi.Actions, abi.ActionDef{Name: name.StringToName("newaccount"), Type: "newaccount", RicardianContract: ""})
	eosAbi.Actions = append(eosAbi.Actions, abi.ActionDef{Name: name.StringToName("setcode"), Type: "setcode", RicardianContract: ""})
	eosAbi.Actions = append(eosAbi.Actions, abi.ActionDef{Name: name.StringToName("setabi"), Type: "setabi", RicardianContract: ""})
	eosAbi.Actions = append(eosAbi.Actions, abi.ActionDef{Name: name.StringToName("updateauth"), Type: "updateauth", RicardianContract: ""})
	eosAbi.Actions = append(eosAbi.Actions, abi.ActionDef{Name: name.StringToName("deleteauth"), Type: "deleteauth", RicardianContract: ""})

	eosAbi.Actions = append(eosAbi.Actions, abi.ActionDef{Name: name.StringToName("linkauth"), Type: "linkauth", RicardianContract: ""})
	eosAbi.Actions = append(eosAbi.Actions, abi.ActionDef{Name: name.StringToName("unlinkauth"), Type: "unlinkauth", RicardianContract: ""})
	eosAbi.Actions = append(eosAbi.Actions, abi.ActionDef{Name: name.StringToName("canceldelay"), Type: "canceldelay", RicardianContract: ""})
	eosAbi.Actions = append(eosAbi.Actions, abi.ActionDef{Name: name.StringToName("onerror"), Type: "onerror", RicardianContract: ""})
	eosAbi.Actions = append(eosAbi.Actions, abi.ActionDef{Name: name.StringToName("onblock"), Type: "onblock", RicardianContract: ""})
