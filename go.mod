module github.com/MetalBlockchain/antelopevm

go 1.20

require (
	github.com/MetalBlockchain/metal-network-runner v1.4.1
...
require (
	...
	github.com/MetalBlockchain/coreth v0.12.1-rc.0 // indirect
